...
PN_CHAT_EXTERN PN_CHAT_EXPORT void pn_message_draft_insert_suggested_mention(Pubnub::MessageDraft* message_draft, std::size_t offset, const char* replace_from, const char* replace_to, const char* target_json, const char* text);
...
PN_CHAT_EXTERN PN_CHAT_EXPORT void pn_message_draft_add_mention(Pubnub::MessageDraft* message_draft, std::size_t start, std::size_t length, const char* target);
...
PN_CHAT_EXTERN PN_CHAT_EXPORT void pn_message_draft_consume_callback_data(Pubnub::MessageDraft* message_draft, char* data);
