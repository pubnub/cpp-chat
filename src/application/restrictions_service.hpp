...
class RestrictionsService : public std::enable_shared_from_this<RestrictionsService>
{
    public:
        ...
        std::tuple<std::vector<Pubnub::ChannelRestriction>, Pubnub::Page, int, Pubnub::String> get_channels_restrictions(const Pubnub::String& user_id, const Pubnub::String& sort = "", int limit = 0, const Pubnub::Page& page = Pubnub::Page()) const;
